...
**Professor:** Murillo Carvalho  
**Aluno(a):** Vitor Alexandre Pereira da Silva - 2312130217  
**Turma:** LFA **Data:** 08/08/2026
...
|---:|---|:---:|---|
| 1 | “As flores são belas.” | A | Adequada |
| 2 | “As flores é bela.” | B | Problema sintático: problema de concordância |
| 3 | “Vou corre hoje no parque.” | C | Problema de formação/escrita |
| 4 | “Água bebeu José.” | B | Problema sintático: problema de ordem |
| 5 | “O aluno acabou a prova.” | A | Adequada |
...
1. A sentença do item 4 é impossível em português ou apenas incomum na ordem mais frequente? Explique.
   ...
   **Resposta:**  
Não é impossível, mas geralmente ela estaria incorreta, pois estaria na ordem errada. Talvez ela funcionaria em algum contexto fantasioso.
...
Classificação: Sintático

Justificativa: Não é possível declarar um valor como uma variável.
...
Justificativa: A forma condicional é `se condição então comando`, então, como ela está invertida, não a segue a gramática correta.
...
Classificação: Semântico

Justificativa: Ele declara uma variável inteiro, mas coloca um valor decimal, gerando incompatibilidade.
...
Justificativa: Toda variável precisa ser declarada antes de ser usada. Então, ela até é correta gramaticalmente, mas não é válida.
...
Classificação: Válido

Justificativa: Sem erros, ‘media’ foi declarada e teve um valor atribuído.
...
Justificativa: Sem erros, ‘a’ foi declarada como inteira, recebe valor inteiro e a condicional está correta.
...
**Explicação:**  
É um verbo, do verbo caminhar, que significa ir a pé de um lugar para outro. 
É um substantivo que significa o trajeto ou percurso a percorrer de um lugar para outro.
...
**Explicação:**  
É um verbo, do verbo colher, que significa separar os frutos, flores ou folhas da planta.
É um substantivo que significa o talher composto por uma parte côncava e por um cabo usado para pegar alimentos.
...
**Resposta:**  
No primeiro trecho, ‘soma’ é o nome da variável. No segundo, ‘soma’ é o nome da função.
O compilador utiliza o tipo que identifica o nome para interpretá-lo corretamente.
...
**Anotações:**  
Se ele desconsiderasse isso, o exemplo anterior não funcionaria corretamente, pois ‘soma’ seria tanto uma variável declarada como função, gerando conflito na execução do código.
Portanto, ao verificar as declarações, tipos e escopos, o código consegue decidir se aquelas instruções escritas estão corretas gramaticalmente.
...
1. O trecho está sintaticamente correto? Justifique.
   ...
   **Resposta:**  
Sim, a gramática do trecho está correta.

2. Há incompatibilidade de tipos ou uso de variável não declarada no trecho apresentado?

   **Resposta:**  
Não há incompatibilidade, nem uso de variável não declarada.

3. O programa realiza o objetivo proposto? Justifique.

   **Resposta:**  
Sim e não, pois ele concede o aumento salarial, entretanto, um aumento muito maior do que o esperado.

4. Classifique o problema como erro sintático, erro semântico estático ou erro lógico.

   **Resposta:**  
Erro lógico, o aluno escreveu errado.
...
|---|---|---|
| Análise léxica | Caracteres e formação de tokens | Palavra ou símbolo invalido |
| Análise sintática | Organização dos tokens segundo a gramática | Comando escrito na ordem incorreta |
| Análise semântica | Significado, tipos, declarações e compatibilidade | Variável não declarada ou tipos incompatíveis |
...
**Resposta:**  
Porque a análise semântica precisa dos tipos identificados pela análise léxica e da gramática correta pela análise sintática para verificar se o código é válido, como tipos compatíveis e variáveis declaradas.
...
- **Léxico** está relacionado a caracteres, palavras e tokens reconhecidos pela linguagem.
- **Sintaxe** está relacionada a estrutura e a organização correta dos elementos da linguagem.
